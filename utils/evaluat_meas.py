...
def emd(x, y, distance_scaling=1.0):
    ...
    d_mat = toeplitz(range(support_size)) 
...
def orca(graph):
    ...
    output = sp.check_output(['orca/orca/orca', 'node', '4', 'orca/orca/tmp.txt', 'std'])
