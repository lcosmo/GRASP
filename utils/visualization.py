#adapted from https://raw.githubusercontent.com/cvignac/DiGress/main/src/analysis/visualization.py
...
class NonMolecularVisualization:
    ...
    def visualize(self, path: str, graphs: list, num_graphs_to_visualize: int, log='graph', largest_component: bool = True):
        # define path to save figures
        if not os.path.exists(path):
            os.makedirs(path)
